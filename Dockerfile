...
RUN dotnet tool install -g Microsoft.dotnet-interactive --version 1.0.358001 --add-source "https://pkgs.dev.azure.com/dnceng/public/_packaging/dotnet-tools/nuget/v3/index.json"
